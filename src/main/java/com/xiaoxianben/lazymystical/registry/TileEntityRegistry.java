...
public class TileEntityRegistry {
    ...
    public TileEntityRegistry() {
        TESeedCultivatorType = TILE_ENTITIES.register("te_seedcultivator",
                () -> TileEntityType.Builder.of(TESeedCultivator::new, BlockRegistry.SEED_CULTIVATOR.stream().map(RegistryObject::get).toArray(Block[]::new)).build(null));
    }
